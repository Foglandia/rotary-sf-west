          ...
          <div className="hidden lg:flex items-center gap-4 border-r pr-4 border-border/50">
            ...
            <a href="https://www.instagram.com/rcsfwest/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-secondary transition-colors" aria-label="Instagram">
              <InstagramIconBetter />
                        ...
                        <a href="https://www.youtube.com/watch?v=aIwZYGSkVrU" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-secondary transition-colors" aria-label="YouTube">
                ...
                <div className="flex flex-col gap-6 mt-8">
                  ...
                  <div className="flex gap-4 mt-4 pt-4 border-t">
                    ...
                    <a href="https://www.instagram.com/rcsfwest/" target="_blank" rel="noopener noreferrer"><InstagramIconBetter /></a>
                                        <a href="https://www.youtube.com/watch?v=aIwZYGSkVrU" target="_blank" rel="noopener noreferrer"><Youtube className="h-5 w-5 hover:text-secondary transition-colors" /></a>
                  </div>
                </div>
              </SheetContent>
            </Sheet>
